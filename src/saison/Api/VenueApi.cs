...
public class VenueApi
{
    ...
    /// <returns></returns>
    public async Task<ResponseContainer<FoursquareLookup>> LookupFoursquare(
        string foursquareVenueId, string? accessToken = null)
    {
    ...
    /// <param name="accessToken"></param>
    /// <returns></returns>
    public async Task<ResponseContainer<VenueActivity>> GetCheckins(
        int venueId, int? maxId = null, int? minId = null, int limit = 25, string accessToken = null)
    {
        var builder = new StringBuilder();
